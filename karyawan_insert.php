...
if ($rowscek < 1) {
	$sql = "INSERT INTO employee(npp,nama_emp,jk_emp,telp_emp,divisi,jabatan,alamat,hak_akses,password,foto_emp,active,id_adm)
		  VALUES('$npp','$nama','$jk','$telp','$divisi','$jabatan','$alamat','$akses','$npp','$newfoto','$aktif','$id')";
