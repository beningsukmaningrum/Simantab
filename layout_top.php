...
<head>
	...
	<title>Sistem Informasi Manajemen dan Tertib Administrasi BNN - <?php echo $pagedesc ?></title>
			...
			<div class="navbar-default sidebar" role="navigation">
				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<a href="#"><i class="fa fa-download fa-fw"></i>&nbsp;Pengajuan Cuti<span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<?php
