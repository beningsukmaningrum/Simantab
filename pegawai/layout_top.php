...
<head>
	...
	<title>Sistem Informasi Manajeman dan Tertib Administrasi- <?php echo $pagedesc ?></title>
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
			<div class="navbar-header">
				...
				<a class="navbar-brand hidden-xs" href="index.php">
					<img src="libs/images/logo.png" alt="brand" width="115" class="float-left image-brand">
				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						<li class="sidebar-search">
							<h4><b>BNN Kabupaten Malang</b></h4>
						...
						?>
						<a href="#"><i class="fa fa-user fa-fw"></i>&nbsp;Pegawai<span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<?php
							if ($pagedesc == "Data Pegawai") {
								echo '<li><a href="data_pegawai.php" class="active">Data Pegawai</a></li>';
							} else {
								echo '<li><a href="data_pegawai.php">Data Pegawai</a></li>';
							}
						...
						<ul class="nav nav-second-level">
							...
							if ($pagedesc == "Approved") {
								echo '<li><a href="cuti_app.php" class="active">Rekapan Cuti</a></li>';
							} else {
								echo '<li><a href="cuti_app.php">Rekapan Cuti</a></li>';
							}
							?>
						</ul><!-- /.nav-second-level -->
						</li>
